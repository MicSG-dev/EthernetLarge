...
public:
  ...
  //__GP_REGISTER_N(UIPR,   0x002A, 4); // Unreachable IP address in UDP mode (W5100 only) //// incorrect for the W5500
  //__GP_REGISTER16(UPORT,  0x002E);    // Unreachable Port address in UDP mode (W5100 only) //// incorrect for the W5500
  /////// W5500 only /////////
